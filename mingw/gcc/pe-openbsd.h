...
#define STARTFILE_SPEC "%{!shared:crt0.o%s} %{shared:crt1.o%s} %{!shared:crtbegin.o%s}"

#undef ENDFILE_SPEC
#define ENDFILE_SPEC "%{!shared:crtend.o%s}"

#undef LIB_SPEC
#define LIB_SPEC "-lsocket -lc -Bdynamic -lmsvcrt -lposix"
...
//#define SIZE_TYPE (TARGET_64BIT ? "unsigned int" : "unsigned int")
#define PTRDIFF_TYPE (TARGET_64BIT ? "long long int" : "int")
//#define PTRDIFF_TYPE (TARGET_64BIT ? "long" : "long")
